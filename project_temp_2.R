...
#ddply(crime_dat, "crime_dat", summarize)
...
crime_count_hourofday_1 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="1")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_2 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="2")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_3 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="3")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_4 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="4")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_5 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="5")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_6 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="6")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_7 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="7")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_8 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="8")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_9 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="9")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_10 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="10")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_11 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="11")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_12 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="12")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_13 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="13")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_14 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="14")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_15 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="15")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_16 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="16")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_17 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="17")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_18 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="18")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_19 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="19")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_20 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="20")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_21 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="21")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_22 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="22")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_23 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="23")%>% tally() %>% arrange(desc(n))
crime_count_hourofday_24 <- temporary_dataset_2 %>% group_by(CrimeCode) %>% filter(hour=="24")%>% tally() %>% arrange(desc(n))




#Please fix boxplot
#temporary_dataset<-crime_dat[,c("year","month","CrimeCode","Description")]
#crime_month <- temporary_dataset %>% group_by(month,year)%>% tally() 
#crime_month$n<-as.factor(crime_month$n)
#ggplot(crime_month, aes(x=month, y=n)) + geom_boxplot()

alt <- read.csv("crime.csv",header = TRUE, sep = ",")
...
#Classifying Data into violent crime and not
...
ind <- sample.split(Y=crime_dat_miss$CrimeViolent, SplitRatio = 0.75)
crime_dat_miss$CrimeViolent <- as.numeric(crime_dat_miss$CrimeViolent)
train_set <- crime_dat_miss[ind,]
test_set <- crime_dat_miss[!ind,]

#CrimeTree <- rpart(CrimeViolent ~ WeekdayCheck, data = train_set , method = "class")
#par(xpd = NA) # Avoid clipping the text in some device
#plot(CrimeTree)
#text(CrimeTree)
...
#CrimeTree <- rpart(CrimeViolent ~ Latitude + Longitude, data = train_set , method = "class")
#plot(CrimeTree)
#text(CrimeTree)

#model <- randomForest(CrimeViolent ~ Latitude + Longitude, data=crime_dat_miss, ntree=200)

#CrimeTree <- rpart(CrimeViolent ~ WeekdayCheck + SeasonCheck, data = train_set , method = "class")
#par(xpd = NA) # Avoid clipping the text in some device
#plot(CrimeTree)
#text(CrimeTree)
